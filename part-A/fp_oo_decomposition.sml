...
(*
   A big learning from this course

   FP and OOP often do the same things in exact opposite way 
   -- Organize the program "by rows" or "by cloumns"

   Which is "more natural" may depend on what you are doing (eg. an interpreter
    vs a GUI) or a personal taste
